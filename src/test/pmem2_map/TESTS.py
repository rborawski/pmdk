...
# XXX: linux test only - it will stay that way
@t.windows_exclude
class TEST30(PMEM2_MAP):
    """
    map a file when addr is initialized and address type request
    PMEM2_ADDRESS_HINT is used
    """
    test_case = "test_map_addr_hint_valid"
